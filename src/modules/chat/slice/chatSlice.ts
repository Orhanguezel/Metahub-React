...
export const selectEscalatedRooms = (state: RootState) =>
  state.chat.escalatedRooms;
export const selectArchivedSessions = (state: RootState) =>
  state.chat.archived.sessions;
export const selectArchivedLoading = (state: RootState) =>
  state.chat.archived.loading;
export const selectArchivedError = (state: RootState) =>
  state.chat.archived.error;

export const selectAllChatSessions = (state: RootState) =>
  state.chat.sessions.all;
export const selectActiveChatSessions = (state: RootState) =>
  state.chat.sessions.active;

export const selectManualMessageState = (state: RootState) =>
  state.chat.manualMessage;
