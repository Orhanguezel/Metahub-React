// src/styles/themes/modernTheme.js
...
const modernTheme = {
  ...
  colors: {
    ...
    shadowHighlight: "0 0 0 3px rgba(99, 102, 241, 0.2)",
    success: "#22c55e",
    warning: "#facc15",
    danger: "#ef4444",
    dangerHover: "#dc2626",
    ...
    inputOutline: "#6366f1",
    inputBackgroundLight: "#fbfbfd",
    inputBackgroundSofter: "#f9fafb",
    inputIcon: "#6b7280",
    tableHeader: "#f7f9fc",
    tagBackground: "#f0f4ff",
    grey: "#6b7280",
    darkGrey: "#4b5563",
    black: "#000000",
    white: "#ffffff",
