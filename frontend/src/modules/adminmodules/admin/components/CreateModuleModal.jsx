...
import { createAdminModule, fetchAdminModules } from "../../slice/adminModuleSlice";
import { useTranslation } from "react-i18next";
import { toast } from "react-toastify";

const CreateModuleModal = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // sabit proje ismi kullan
      await dispatch(fetchAdminModules("radanor"));
      toast.success(
        t(
          "success.created",
    ...
    <Overlay>
      <Modal>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <SubmitButton type="submit">{t("createSubmit", "Create")}</SubmitButton>
        </Form>
      </Modal>
    </Overlay>
  );
