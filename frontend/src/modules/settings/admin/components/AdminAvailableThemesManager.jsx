...
export default function AdminAvailableThemesManager({ availableThemes, onThemesChange }) {
  ...
  const handleAddTheme = async () => {
    ...
    try {
      await dispatch(upsertSetting({ key: "available_themes", value: updatedThemes })).unwrap();
  ...
  const handleDeleteTheme = async (themeToDelete) => {
